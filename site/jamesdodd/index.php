...
<head>
	...
	<script type='text/javascript' src='<%baseurl%><%basename%>/site/<%obj_theme%>/js.js'></script>
	<plug:front_lib_js />
	<script type='text/javascript'>
		...
		$(function() {          
		    $("img").lazyload({
		    	placeholder : "http://jamesdodd.net/images/grey.gif",
			    effect      : "fadeIn",
		    });
		});
	</script> 
...
<body class='section-<%section_id%>'>
	<div id='menu'>
		<div class='container'>
			...
			<li>Customised by <a href='http://www.jamesdodd.net/'>James Dodd</a></li>
			</ul>
			</div>
		</div>	
	</div>	
